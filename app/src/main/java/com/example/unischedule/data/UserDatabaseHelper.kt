...
class UserDatabaseHelper(context: Context) : SQLiteOpenHelper(
    ...
    private fun insertSampleLessons(db: SQLiteDatabase) {
        ...
        val lessons = listOf(
            ...
            Lesson(0, "Математический анализ", "08:30", "10:00", "Смирнова А.В.", "101", 1, true, demoUserId),
            Lesson(0, "Программирование", "10:10", "11:40", "Козлов Д.М.", "305", 1, true, demoUserId),

            Lesson(0, "Линейная алгебра", "08:30", "10:00", "Петрова Е.С.", "102", 1, false, demoUserId),
            Lesson(0, "Базы данных", "10:10", "11:40", "Сидоров К.А.", "410", 1, false, demoUserId),

            Lesson(0, "Физика", "09:00", "10:30", "Николаев П.П.", "203", 2, true, demoUserId),
            Lesson(0, "Английский язык", "12:40", "14:00", "Иванова М.И.", "118", 2, true, demoUserId),

            Lesson(0, "Дискретная математика", "09:00", "10:30", "Кузнецов В.В.", "201", 2, false, demoUserId),

            Lesson(0, "Операционные системы", "10:10", "11:40", "Морозов А.Н.", "412", 3, true, demoUserId),
            Lesson(0, "Компьютерные сети", "14:10", "15:40", "Волков С.Р.", "308", 3, true, demoUserId),

            Lesson(0, "Архитектура ЭВМ", "10:10", "11:40", "Соколов И.Д.", "405", 3, false, demoUserId),
            Lesson(0, "Теория вероятностей", "14:10", "15:40", "Орлова Т.М.", "210", 3, false, demoUserId),

            Lesson(0, "Алгоритмы и структуры данных", "08:30", "10:00", "Белов Р.Е.", "307", 4, true, demoUserId),
            Lesson(0, "Веб-разработка", "12:40", "14:00", "Лебедев Н.К.", "415", 4, true, demoUserId),

            Lesson(0, "Машинное обучение", "08:30", "10:00", "Городецкий Э.Р.", "412", 4, false, demoUserId),

            Lesson(0, "Философия", "10:10", "11:40", "Павлова О.А.", "105", 5, true, demoUserId),
            Lesson(0, "Экономика", "14:10", "15:40", "Федорова Л.В.", "220", 5, true, demoUserId),

            Lesson(0, "История информатики", "10:10", "11:40", "Егоров А.С.", "106", 5, false, demoUserId),
            Lesson(0, "Защита информации", "14:10", "15:40", "Козлова Н.П.", "401", 5, false, demoUserId),

            Lesson(0, "Физическая культура", "09:00", "10:30", "Быков В.И.", "Спортзал", 6, true, demoUserId),

            Lesson(0, "Практика программирования", "09:00", "10:30", "Новиков Д.А.", "310", 6, false, demoUserId)
        )
